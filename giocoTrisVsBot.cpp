...
void turnoSegnoBot(string campo[], int segnoBOT)
{
    segnoBOT=(rand()%9)+1;

    if(campo[segnoBOT - 1] == "X" or campo[segnoBOT - 1] == "O")
    {
        segnoBOT = 0;
        segnoBOT=(rand()%9)+1;
...
int main(){ 
    ...
    string campo[dim];
    int varAvanti, varAvanti2, segno1, segno2, segnoBOT, fineProgramma, endCiclo, menu;
    string player1, player2, player1VsBot;
    ...
    cout<<"\nInserire: \n 1. Se si vuole giocare contro un Bot!\n2. Se si vuole giocare contro un umano!\n";
    cin>>menu;

    switch (menu)
    {
        case 1: cout<<"\nHai scelto di giocare umano contro umano!\n"
            ...
            break;
        case 2: cout<<"\nHai scelto di giocare contro un bot!\n";
                cout<<"\nInserire 1 per iniziare a giocare . . . ";
                cin>>varAvanti2;
